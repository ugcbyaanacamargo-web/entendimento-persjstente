...
1. **Recuperar** [estado atual](../projects/formatacao-correta/estado-atual.md), [evidências](../projects/formatacao-correta/registro-de-evidencias.md) e a nota temática.
...
6. **Decidir uma próxima ação:** corrigir, já corrigido, histórico encerrado, limitação ou encaminhamento especializado. Atualizar estado, nota específica e índice quando houver nota nova.
7. **Gravar/validar:** conferir alterações, links relativos, commit, leitura de volta pelo GitHub e branch HEAD. Só então confirmar persistência.
