...
| --- | --- | --- | --- | --- |
| ACPI / EC / energia | `_WAK`, `_PSR`, FADT, TPM CRB | EC Event 13/15; Event 37; Kernel-Power 41 em agosto; teste 04/09 sem novos eventos-alvo | Ambos relataram problemas na comunicação/energia de firmware | Não afirmar que uma função específica causou toda tela azul |
...
| Armazenamento | Sem equivalente específico no resumo | WHEA histórico com cadeia storahci/WD Green; teste SATA/PHY 04/09 sem novos WHEA no intervalo | Nenhuma evidência cruzada específica ainda | Não apontar SSD físico como culpado |
| Memória | Sem equivalente demonstrado no resumo | BSOD 0x1A/0x41792 em 23/09 | Não comprovada causa comum | MemTest final PASS relatado não identifica driver culpado |
...
[Funil causal](./triagem-causal-consolidada.md) · [Projeto](./README.md) · [Firmware](./firmware-seguranca.md) · [ACPI](./acpi-ec-energia-tpm.md) · [Memória](./memoria-e-tela-azul.md) · [Fontes](./fontes-e-lacunas.md).