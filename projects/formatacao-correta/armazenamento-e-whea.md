...
## Verificacao adicional, sem intervencao no driver Boot, 23/09 ~22h35–22h44 (EV-36/37)

- Lenovo [pagina 80YH](https://pcsupport.lenovo.com/br/pt/products/laptops-and-netbooks/300-series/320-15ikb/80yh/downloads) agrupa familia 320-15IKB, mas a descricao aberta de [DS121515](https://pcsupport.lenovo.com/ni/en/products/laptops-and-netbooks/300-series/320-15ikb/downloads/ds121515) ainda lista **80XL e 80YE**; nao declarar suporte EXPLICITO a 80YH para rollback sem validar o hardware ID no INF e referencia Lenovo. [Intel](https://www.intel.com/content/www/us/en/support/articles/000027232/technologies/intel-rapid-storage-technology-intel-rst.html) recomenda driver OEM especificamente para notebook. A diferenca de versoes aumenta suspeita de regressao, NAO prova que o 17.8 causou o ID129.
- `iaStorAC` esta Boot/Running; `BusType=11`, `IoLatencyCap=500` em Parameters. Valor nao e permissao para alterar timeout. O plano Equilibrado em AC nao expôs HIPM/Adaptive ao powercfg /query, logo NAO presumir que modo LPM esteja habilitado ou desabilitado no Intel RST. A [Microsoft descreve o controle AHCI oculto](https://learn.microsoft.com/en-us/windows-hardware/customize/power-settings/disk-settings-link-power-management-mode---hipm-dipm), mas a descricao generica nao garante que o miniport Intel honre esse ajuste.
- Ultimo filtro ate ~22h44: **nenhum ID129/153/154/7/11/51 NOVO apos 21h46**; `AppXSvc` segue Running, Verifier 0. Os contadores `ReadLatencyMax`/`WriteLatencyMax` documentam MAXIMOS em toda janela reportada, nao uma operacao datada, [Microsoft](https://learn.microsoft.com/en-us/windows-hardware/drivers/storage/msft-storagereliabilitycounter). Nao zerar maxima por estetica. Sem novo benchmark nem firmware.
